...
resultMsg = ""
resultPath = "StudentData/output.txt"
...
# for f in lastFiles:
    # os.remove(f)
subprocess.Popen(["C:\\Users\\kelly\\Desktop\\NCHU-NLPLab-PEGolf\\OpenPose\\Golf_Run\\run\\OpenPoseDemo.exe","--model_folder","C:\\Users\\kelly\\Desktop\\NCHU-NLPLab-PEGolf\\OpenPose\\Golf_Run\\models","--video","D:\\DataSet\\202306\\0601_1\\Student_1_{std}\\Student_1_{std}_{swing}.mp4".format(std=std, swing=swing),"--num_gpu_start","0","-number_people_max","1","--write_json","D:\\DataSet\\202306\\0601_1\\Student_1_{std}\\output\\json\\swing{swing}\\".format(std=std, swing=swing),"--write_images", "output_imgs\\",])
time.sleep(1)
